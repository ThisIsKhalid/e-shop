...
export default function Footer() {
  return (
    <footer className="pt-5 md:pt-10">
      <div className="bg-secondary py-5 px-5 md:px-10 ">
        <div className="flex flex-col items-start justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3 -mt-1">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full relative overflow-hidden">
                <img
                  src="/logo.png"
                  alt=""
                  className="rounded-full absolute scale-125"
                />
              </div>
              <span className="self-center text-3xl md:text-4xl logo">
                Fashion Bazar
              </span>
            </a>
          </div>
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                ...
                <li className="hover:text-primary hover:font-bold hover:ml-2 transition-all duration-300 ease-in-out">
                  <Link to="/">COMFY TROUSER</Link>
                </li>
                <li className="hover:text-primary hover:font-bold hover:ml-2 transition-all duration-300 ease-in-out">
                  <Link to="/">SPORTS TROUSER</Link>
                </li>
              </ul>
            </div>
            <div className="space-y-3">
      ...
      {/* lower section */}
      <div className="bg-gray-50 py-5 px-5 md:px-10">
        <p className="text-sm  md:text-center text-justify">
          FASHION-BAZAR prints a huge variety of custom clothing like T-shirts,
        ...
        <p className="text-sm flex md:flex-row flex-col items-center justify-center md:gap-10 gap-2 mt-5">
          ...
          <span className="">
            ...
            <a
              href="
                    https://www.linkedin.com/in/khalid-hasan97
                "
              target="_blank"
              rel="noopener noreferrer"
